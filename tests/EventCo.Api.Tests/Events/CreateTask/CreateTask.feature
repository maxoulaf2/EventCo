...
Fonctionnalité: Création d'une tâche via l'API
  ...
  Scénario: Création sur un événement inexistant
    ...
    Quand j'ajoute la tâche "Bûche au chocolat" de catégorie "Courses" et de quantité "1" à un événement inexistant via l'API
    Alors la réponse de création de tâche a le statut 404

  Scénario: Création sans cookie de session
    Quand j'ajoute la tâche "Bûche au chocolat" de catégorie "Courses" et de quantité "1" à un événement inexistant via l'API sans cookie de session
  ...
  Scénario: Création avec une catégorie invalide
    Etant donné une session ouverte via l'API pour "create-task-invalid-category-api-test@example.com"
    Et un événement "Repas de Noël" créé via l'API
    Quand j'ajoute la tâche "Bûche au chocolat" de catégorie "Desserts" et de quantité "1" à cet événement via l'API
    Alors la réponse de création de tâche a le statut 400
