...
namespace EventCo.Application.Tests.Auth.RequestLoginCode;

[Binding]
public sealed class RequestLoginCodeSteps
{
    ...
    public void AlorsLeCodeEnvoyeNestPasStockeEnClair()
    {
        ...
        var token = _dbContext.LoginCodes.Single();

        Assert.NotEqual(code, token.CodeHash);
    }
    ...
    {
        Assert.IsType<TooManyLoginCodeRequestsException>(_thrownException);
    }
