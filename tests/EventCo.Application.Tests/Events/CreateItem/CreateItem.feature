...
Fonctionnalité: Création d'un article sur un événement
  En tant que participant d'un événement je veux ajouter un article
  afin de répartir ce qu'il reste à faire

  Scénario: Création d'un article par le créateur
    Etant donné un événement ouvert à l'ajout d'articles "Repas de Noël" prévu le "2026-12-24" au lieu "Chez Alice"
    Quand j'ajoute l'article "Bûche au chocolat" de quantité "1" à cet événement
  ...
  Scénario: Création d'un article par un participant simple (non organisateur)
    Etant donné un événement ouvert à l'ajout d'articles "Repas de Noël" prévu le "2026-12-24" au lieu "Chez Alice"
  ...
  Scénario: Création d'un article avec un titre vide
    Etant donné un événement ouvert à l'ajout d'articles "Repas de Noël" prévu le "2026-12-24" au lieu "Chez Alice"
    Quand j'ajoute l'article " " de quantité "1" à cet événement
  ...
  Scénario: Création d'un article sur un événement inexistant
    Quand j'ajoute l'article "Bûche au chocolat" de quantité "1" à un événement inexistant
